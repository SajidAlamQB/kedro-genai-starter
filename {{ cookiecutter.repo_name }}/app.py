...
@app.get("/hack/results")
async def get_results():
    """
    Retrieves the content of the results file generated by the agent_rag pipeline.
    """
    results_file_path = "data/08_reporting/output.md"  # Adjust path if necessary
    try:
